...
`git clone --recursive https://github.com/RSDK-Extended/RSDKv3-Extended`
...
- Your favorite package manager here, [make a pull request](https://github.com/RSDK-Extended/RSDKv3-Extended/fork)
